...
import cardloader.icode.cardloader.CardDialog;
import cardloader.icode.cardloader.DBHelper;
import cardloader.icode.cardloader.R;
import cardloader.icode.cardloader.Setting;
import cardloader.icode.cardloader.google.ui.camera.CameraSource;
import cardloader.icode.cardloader.google.ui.camera.CameraSourcePreview;
...
public final class OcrCaptureActivity extends AppCompatActivity implements View.OnClickListener{
   ...
   static String txtData="";
    ...
    EditText textEdit;
    Button btnRecharge;
    LinearLayout imageDialogLayout;
    String txt;
    ...
    public void onCreate(Bundle bundle) {
        ...
        textEdit = (EditText) findViewById(R.id.image_dialog_textEdit);
...
//        progressDoalog=new ProgressDialog(OcrCaptureActivity.this);
...
//                tts.speak(text.getValue(), TextToSpeech.QUEUE_ADD, null, "DEFAULT");
                if(type.equals("multiple")){
                    if(txtData.isEmpty() || txtData.equals("")){ txtData=text.getValue();}
                    else {txtData=txtData+","+text.getValue();}

                }else{
                    txtData="";
                    txtData=text.getValue();
                }
                textEdit.setText(txtData);
                textEdit.setVisibility(View.VISIBLE);
            }
            else {
...
//        progressDoalog.dismiss();
    ...
    public void recharge(){
        ...
        txt=textEdit.getText().toString().trim().replace("-","").replace(" ","");
